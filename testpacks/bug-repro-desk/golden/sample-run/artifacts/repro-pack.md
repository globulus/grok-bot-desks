...
## Environment
unknown / iOS Simulator 18 claimed by reporter / staging-not-connected (harness fixture only)

## Account
none (fixture)

## Preconditions
Debug Flutter counter sample or harness /staging/counter. No production data.

## Steps
1. Open the counter on staging fixture or simulator.
2. Confirm the displayed number is 0.
3. Tap the + control once.
...
## Not tried
Live simulator beyond fixture page, production, GitHub comment
